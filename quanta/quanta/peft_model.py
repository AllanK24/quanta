...
from .tuners import QuanTAModel
from .utils import (
...
class PeftModel(PushToHubMixin, torch.nn.Module):
    ...
    def __init__(self, model, peft_config: PeftConfig):
        ...
        if isinstance(self.peft_config, PromptLearningConfig):
            ...
            if self.peft_config.peft_type == PeftType.QUANTA:
                self.base_model = QuanTAModel(peft_config, model)
    ...
    def from_pretrained(cls, model, model_id, **kwargs):
        ...
        if getattr(model, "hf_device_map", None) is not None:
            ...
            if (
                ...
                or model.peft_config.peft_type == PeftType.BOTTLENECK
                or model.peft_config.peft_type == PeftType.QUANTA
            ):
